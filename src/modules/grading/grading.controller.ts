...
export class GradingController {
  constructor(
    private readonly queries: GradingQueryUseCases,
    private readonly grading: GradeAnswerUseCases,
    private readonly regrading: RegradeUseCases,
    private readonly visibility: GradeVisibilityUseCases,
  ) {}
  ...
  attemptDetail(@Param('attemptId') attemptId: string, @CurrentUser() user: RequestUser) {
    return this.queries.attemptDetail(attemptId, user);
  }
  ...
  regradeAttempt(@Param('attemptId') attemptId: string, @CurrentUser() user: RequestUser) {
    return this.regrading.regradeAttempt(attemptId, user);
  }
