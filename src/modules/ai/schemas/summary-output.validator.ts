...
import {
  ...
  CLASS_SUMMARY_OUTPUT_SCHEMA,
  CLASS_SUMMARY_OUTPUT_SCHEMA_VERSION,
  PARENT_REPORT_OUTPUT_SCHEMA,
  PARENT_REPORT_OUTPUT_SCHEMA_VERSION,
  LESSON_ASSISTANT_OUTPUT_SCHEMA,
...
export class SummaryOutputValidator {
  ...
  constructor() {
    ...
    this.validators = new Map([
      ...
      [CLASS_SUMMARY_OUTPUT_SCHEMA_VERSION, ajv.compile(CLASS_SUMMARY_OUTPUT_SCHEMA)],
      [PARENT_REPORT_OUTPUT_SCHEMA_VERSION, ajv.compile(PARENT_REPORT_OUTPUT_SCHEMA)],
      [LESSON_ASSISTANT_OUTPUT_SCHEMA_VERSION, ajv.compile(LESSON_ASSISTANT_OUTPUT_SCHEMA)],
    ]);
  }
