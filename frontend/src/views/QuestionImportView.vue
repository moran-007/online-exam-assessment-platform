            ...
            <el-form :model="singleForm" label-width="88px">
              ...
              <template v-if="singleForm.type === 'programming'">
                ...
                <el-form-item label="Hydro站点">
                  <el-input v-model="singleForm.programmingRef.platformBaseUrl" placeholder="例如 http://moran007.top" />
                </el-form-item>
...
const singleHydroProblemUrl = computed(() => {
  ...
  const baseUrl = normalizeBaseUrl(singleForm.programmingRef.platformBaseUrl || 'http://moran007.top');
