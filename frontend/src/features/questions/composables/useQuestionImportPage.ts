...
export function useQuestionImportPage(): any {
...
return {
  ...
  buildSingleFillBlankPreviewAnswer,
  buildSinglePreview,
  ...
  importMode,
  importSingle,
  importableBatchCount,
  importing,
  insertCodeBlock,
  insertFormatSnippet,
  insertMarkdownSnippet,
  insertMaterialChildBlankMarker,
  insertSingleBlankMarker,
  insertUploadedAsset,
  isChoiceType,
  isMeaningfulName,
  isSingleChoice,
  ...
  materialChildDialogTitle,
  materialChildDialogVisible,
  materialChildDraft,
  materialChildLocalId,
  materialChildTypeOptions,
  ...
  scheduleSingleDuplicateCheck,
  selectPreview,
  selectedBatchQuestion,
  selectedCourseName,
  selectedKnowledgeNames,
  selectedMaterialChild,
  ...
  singleConflictStatus,
  singleDuplicateChecking,
  singleDuplicateTimer,
  singleEntryTip,
  singleForm,
  singleHydroBindingLabel,
